...
def cornersHeuristic(state, problem):
    ...
    while len(unvisitedCorners) > 0:
        distance, corner = min([(util.manhattanDistance(currentPoint, corner),
...
def foodHeuristic(state, problem):
    ...
    "*** YOUR CODE HERE ***"
    # if not "wallCount" in problem.heuristicInfo:
...
def closestPoint(fromPoint, candidatesList):
    ...
    closest = candidatesList[0]
    closestCost = util.manhattanDistance(fromPoint, closest)
